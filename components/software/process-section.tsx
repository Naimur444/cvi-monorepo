...
export default function ProcessSection() {
  ...
  return (
    <section ref={sectionRef} className="w-full px-6 py-20 bg-[#F9F9F9]">
      <motion.div
      ...
      >
        ...
        <motion.p
          className="mt-4 pt-4 mx-auto text-lg text-gray-700"
          ...
          {columns.map((col, colIdx) => (
            ...
            >
              <div className="max-w-7xl mx-auto w-full">
                <h3 className="text-xl font-semibold text-[#0E4F53] mb-4">{col.title}</h3>
                <ul className="space-y-2 text-gray-700">
                  {col.items.map((item, i) => (
                    ...
                    >
                      <BadgeCheck className="h-5 w-5 text-[#0E4F53]" />
                      <span>{item}</span>
                    </motion.li>
                  ))}
                </ul>
