    ...
    <section>
      ...
      <div className="bg-white p-4 rounded-2xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <p className="text-[#181818] mb-2">Image 01</p>
              <div className="border-2 border-dashed border-[#0E4F53] rounded-lg p-4 flex flex-col items-center justify-center space-y-6 w-full">
                <div>
                  <svg
            ...
            <div>
              <p className="text-[#181818] mb-2">Image 02</p>
              <div className="border-2 border-dashed border-[#0E4F53] rounded-lg p-4 flex flex-col items-center justify-center space-y-6 w-full">
                <div>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
