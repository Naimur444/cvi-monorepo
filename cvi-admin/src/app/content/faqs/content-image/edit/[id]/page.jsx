...
const EditContentImagePage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // In real app, make API call to update the content image
      console.log("Updating content image:", formData);

      // Show success message (you can add toast notification here)
      alert("Content image updated successfully!");

      // Navigate back to FAQs page
      router.push("/content/faqs");
    } catch (error) {
      console.error("Error updating content image:", error);
      alert("Error updating content image. Please try again.");
    } finally {
      setIsLoading(false);
    }
  };
  ...
  const handleDelete = async () => {
    if (
      ...
      try {
        ...
        // In real app, make API call to delete the content image
        console.log("Deleting content image with ID:", params.id);

        alert("Content image deleted successfully!");
        router.push("/content/faqs");
      } catch (error) {
        console.error("Error deleting content image:", error);
        alert("Error deleting content image. Please try again.");
      } finally {
        setIsLoading(false);
      }
    }
        ...
        <div className="bg-white rounded-2xl p-4">
          ...
          <form onSubmit={handleSubmit}>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
              ...
              <div>
                <div className="flex flex-col mb-4">
                  <label className="text-[#181818] mb-2">Content Image</label>
...
export default EditContentImagePage;
