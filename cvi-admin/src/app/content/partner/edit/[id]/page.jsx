...
const EditPartnerPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // In real app, make API call to update the partner
      console.log("Updating partner:", formData);

      // Show success message (you can add toast notification here)
      alert("Partner updated successfully!");

      // Navigate back to partner page
  ...
  const handleDelete = async () => {
    if (
      ...
      try {
        ...
        // In real app, make API call to delete the partner
        console.log("Deleting partner with ID:", params.id);
        ...
        <div className="bg-white rounded-2xl p-4">
          ...
          <form onSubmit={handleSubmit}>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
              ...
              <div>
                <p className="text-[#181818] mb-2">Partner Logo</p>
                <div className="border-2 border-dashed border-[#0E4F53] rounded-lg p-4 flex flex-col items-center justify-center space-y-6">
                  ...
                  <p className="text-[#181818] text-center">
                    Choose or drag & drop a logo image
                  </p>
