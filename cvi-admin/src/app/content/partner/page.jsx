    ...
    },
    {
      ...
      render: (_, row) => (
        <div className="flex gap-2">
          <Link href={`/content/partner/edit/${row.id}`}>
            <button
    ...
    <section>
        ...
        <div className="bg-white rounded-2xl mt-6 p-4">
          <div className="flex items-center justify-between mb-6">
            <h3 className="text-[#181818] font-semibold text-xl">Partner</h3>
            <Link href={"/content/partner/add-partner"}>
          ...
          <div className="flex justify-between items-center mt-4 px-4">
            ...
            <div className="flex space-x-2">
              ...
              <button
                ...
                className="px-3 py-1 rounded-md border border-[#DCDCDC] disabled:bg-[#DCDCDC] disabled:cursor-not-allowed hover:bg-gray-100 transition-colors"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                ...
                >
                  <path
                    ...
                    fill={currentPage === 1 ? "#9CA3AF" : "#181818"}
                  />
                </svg>
              </button>
              ...
              {getPageNumbers().map((page, index) => (
                <button
                  ...
                  className={`px-3 py-1 rounded border transition-colors ${
                    page === currentPage
                      ? "bg-[#0E4F53] text-white border-[#0E4F53]"
                      : page === "..."
              ...
              >
                ...
                >
                  <path
                    ...
                    fill={currentPage === totalPages ? "#9CA3AF" : "#656565"}
                  />
                </svg>
              </button>
            </div>
