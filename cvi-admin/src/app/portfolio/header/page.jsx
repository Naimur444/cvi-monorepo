...
const HeaderPage = () => {
  const [headers, setHeaders] = useState([
    ...
    {
      id: 2,
      title: "Modern Portfolio Showcases",
      image: "/placeholder.jpg",
      status: true,
    },
    {
  ...
  const handleDelete = (rowId) => {
    if (
      ...
      setHeaders((prev) => prev.filter((item) => item.id !== rowId));
    }
  };
    ...
    },
    {
      ...
      render: (_, row) => (
        <div className="flex gap-2 items-center">
          <Link href={`/portfolio/header/edit/${row.id}`}>
            <button
    ...
    <section>
        ...
        <div className="bg-white rounded-2xl mt-6 p-4">
          <div className="flex items-center justify-between mb-6">
            ...
            <Link href={"/portfolio/header/add-header"}>
