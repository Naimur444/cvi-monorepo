...
const WorkPage = () => {
  const [works, setWorks] = useState([
    { id: 1, name: "Website Redesign", status: true },
    { id: 2, name: "Mobile Banking App", status: true },
    { id: 3, name: "Brand Identity Kit", status: false },
  ]);
    ...
    },
    {
      ...
      render: (_, row) => (
        <div className="flex gap-2 items-center">
          <Link href={`/portfolio/work/edit/${row.id}`}>
            <button
  ...
  return (
    <section>
      <MenuItem parent={"Portfolio"} page={"Work"} href={"/portfolio/work"} />
      ...
      <div className="bg-white rounded-2xl mt-6 p-4">
        <div className="flex items-center justify-between mb-6">
          ...
          <Link href={"/portfolio/work/add-work"}>
