            ...
            <table className="min-w-full text-left text-sm text-gray-700">
              ...
              <tbody>
                <tr className="border-b border-[#DCDCDC] align-top">
                  ...
                  <td className="px-4 py-3">Bangladesh</td>
                  <td className="px-4 py-3 ">Location</td>
                  <td className="px-4 py-3 max-w-xs truncate">
                    58/31/3-b, North Mugdapara Dhaka-1214, Bangladesh
                  </td>
                  ...
                  <td className="px-4 py-3">abc@gmail.com</td>
                  <td className="px-4 py-3 flex gap-2 items-center">
                    {/* Edit Icon */}
                    <Link href="/contact/edit-contact/1">
                      <button
                    ...
                    <button
                      ...
                      onClick={() => {
                        if (
                          ...
                          console.log("Deleting contact with ID: 1");
                          alert("Contact deleted successfully!");
                          // You can add logic to refresh the page or remove the row from the table
                        }
                      }}
                    >
                      <svg
