...
const ContactPage = () => {
  const [contacts, setContacts] = useState([
    ...
    },
    {
      ...
      location: "New York",
      address: "123 Business Street, Manhattan, NY 10001, USA",
      phone: "+1-555-123-4567",
      email: "contact@cloudvortex.com",
      status: true,
    },
    {
      id: 3,
      ...
      location: "London",
      address: "45 Tech Avenue, London EC1A 4HD, UK",
      phone: "+44-20-7946-0958",
      email: "uk@cloudvortex.com",
      status: false,
    },
    {
      id: 4,
      country: "Canada",
      location: "Toronto",
      address: "789 Innovation Drive, Toronto, ON M5H 2N2, Canada",
      phone: "+1-416-555-0123",
      email: "canada@cloudvortex.com",
      status: true,
    },
  ]);
    ...
    },
    {
      ...
      render: (_, row) => (
        <div className="flex gap-2">
          <Link href={`/contact/edit-contact/${row.id}`}>
            <button
      ...
      <Layout>
        ...
        <div className="bg-white rounded-2xl mt-6 p-4">
          <div className="flex items-center justify-between mb-6">
            <h3 className="text-[#181818] font-semibold text-xl">Contact</h3>
            <Link href={"/contact/add-contact-info"}>
