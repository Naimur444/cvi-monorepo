...
const AdvantagePage = () => {
  const [advantages, setAdvantages] = useState([
    ...
    {
      id: 2,
      text: "Scalable Cloud Solutions for Modern Enterprises",
      image: "/placeholder.jpg",
      status: false,
    },
    {
      id: 3,
      text: "Advanced Security and Compliance Standards",
      image: "/placeholder.jpg",
      status: true,
    },
    {
    ...
    {
      id: 5,
      text: "Cost-Effective Infrastructure Management",
      image: "/placeholder.jpg",
      status: false,
    },
  ]);
  ...
  const handleStatusToggle = (advantageId, newStatus) => {
    setAdvantages((prev) =>
      prev.map((advantage) =>
        advantage.id === advantageId
          ? { ...advantage, status: newStatus }
          : advantage
      )
    );
  };
  ...
  // Handle delete
  const handleDelete = (advantageId) => {
    if (
      window.confirm(
      ...
      setAdvantages((prev) =>
        prev.filter((advantage) => advantage.id !== advantageId)
      );
    }
  };
    ...
    },
    {
      ...
      render: (_, row) => (
        <div className="flex gap-2">
          <Link href={`/content/advantages/edit/${row.id}`}>
            <button
