...
const ContactFormPage = () => {
  const [contactForms, setContactForms] = useState([
    ...
    {
      id: 2,
      title: "Get in Touch for Custom Solutions",
      subtitle:
        "Our team is ready to help you build innovative solutions tailored to your business needs.",
      email: "contact@cloudvortexinnovation.com",
      user: {
        name: "Sarah Johnson",
    ...
    },
    {
      ...
      subtitle:
        "Transform your business with our cutting-edge technology solutions and expert guidance.",
      email: "support@cloudvortexinnovation.com",
      user: {
        name: "Michael Chen",
  ...
  const handleStatusToggle = (formId, newStatus) => {
    ...
    },
    {
      ...
      render: (value) => (
        <div className="space-y-2">
          ...
          <p className="text-xs text-gray-500">{value.position}</p>
        </div>
      ),
    },
    {
    ...
    },
    {
      ...
      render: (_, row) => (
        <div className="flex gap-2">
          <Link href={`/content/contact-form/edit/${row.id}`}>
            <button
      ...
      <Layout>
        ...
        <div className="bg-white rounded-2xl mt-6 p-4">
          <div className="flex items-center justify-between mb-6">
            ...
            <Link href={"/content/contact-form/add-contact-form"}>
