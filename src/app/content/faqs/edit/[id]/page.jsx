...
const EditFaqsPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // In real app, make API call to update the FAQ
      console.log("Updating FAQ:", formData);

      // Show success message (you can add toast notification here)
      alert("FAQ updated successfully!");

      // Navigate back to FAQs page
  ...
  const handleDelete = async () => {
    if (
      ...
      try {
        ...
        // In real app, make API call to delete the FAQ
      ...
      <Layout>
        ...
        <div className="bg-white rounded-2xl p-4">
          <div className="flex items-center justify-between mb-6">
            <h3 className="text-[#181818] font-semibold text-xl">Edit FAQ</h3>
            <button
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
              <div>
                <div className="flex flex-col mb-4">
                  <label className="text-[#181818] mb-2">Question</label>
                  <textarea
                    name="question"
                ...
                <div className="flex flex-col mb-4">
                  <label className="text-[#181818] mb-2">Answer</label>
                  <textarea
                    name="answer"
                    value={formData.answer}
                    onChange={handleInputChange}
                    className="bg-[#FAF9FC] text-gray-700 rounded-lg border border-[#DCDCDC] py-2 px-3 focus:outline-none focus:ring-2 focus:ring-[#0E4F53] focus:border-transparent min-h-[150px] resize-none"
