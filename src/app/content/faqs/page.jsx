...
const FaqsPage = () => {
  ...
  const [isOnStatus, setIsOnStatus] = useState(false);
  ...
  const handleToggleStatus = () => {
    const newState = !isOnStatus;
    setIsOnStatus(newState);
    if (onChange) onChange(newState);
  };
        ...
        <div className="bg-white rounded-2xl my-6 p-4">
          ...
          <div className="overflow-x-auto shadow-sm">
            <table className="min-w-full text-left text-sm text-gray-700">
              ...
              <tbody>
                <tr className="border-b border-[#F4F3F7]">
                ...
                <tr className="border-b border-[#DCDCDC]">
                  ...
                  <td className="px-4 py-3">
                    <label className="inline-flex items-center cursor-pointer">
                      ...
                      <div
                        className={`w-11 h-6 rounded-full transition-colors relative ${
                          isOnStatus ? "bg-[#0E4F53]" : "bg-gray-300"
                        }`}
                      >
                        <div
                          className={`absolute top-1 left-1 w-4 h-4 bg-white rounded-full transition-transform ${
                            isOnStatus ? "translate-x-5" : ""
                          }`}
                        ></div>
                      </div>
                    </label>
