...
const PolicyPage = () => {
  const [policies, setPolicies] = useState([
    {
      id: 1,
      description: "Empowering Business With Cloud Vortex Innovation",
      status: true,
    },
    {
      id: 2,
      description: "Data Collection and Processing Guidelines",
      status: false,
    },
    {
      id: 3,
      description: "User Consent and Cookie Management",
      status: true,
    },
    {
      id: 4,
    ...
    {
      id: 5,
      description: "Data Retention and Deletion Procedures",
      status: false,
    },
  ]);

  // Handle status toggle
  const handleStatusToggle = (policyId, newStatus) => {
    setPolicies((prev) =>
      prev.map((policy) =>
    ...
    },
    {
      ...
      render: (_, row) => (
        <div className="flex gap-2">
          <Link href={`/content/policy/edit/${row.id}`}>
            <button
      ...
      <Layout>
        ...
        <div className="bg-white rounded-2xl mt-6 p-4">
          <div className="flex items-center justify-between mb-6">
            ...
            <Link href={"/content/policy/add-policy"}>
