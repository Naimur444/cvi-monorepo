...
const TermsPage = () => {
  const [terms, setTerms] = useState([
    ...
    {
      id: 2,
      content: "Service Level Agreement and Performance Standards",
      status: false,
    },
    {
      id: 3,
      content: "Data Protection and Privacy Compliance",
      status: true,
    },
    {
      id: 4,
    ...
    {
      id: 5,
      content: "Payment Terms and Billing Policies",
      status: false,
    },
  ]);

  // Handle status toggle
  const handleStatusToggle = (termId, newStatus) => {
    setTerms((prev) =>
      prev.map((term) =>
    ...
    },
    {
      ...
      render: (_, row) => (
        <div className="flex gap-2">
          <Link href={`/content/terms/edit/${row.id}`}>
            <button
      ...
      <Layout>
        ...
        <div className="bg-white rounded-2xl mt-6 p-4">
          <div className="flex items-center justify-between mb-6">
            <h3 className="text-[#181818] font-semibold text-xl">Terms</h3>
            <Link href={"/content/terms/add-terms"}>
