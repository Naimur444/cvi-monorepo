...
const CategoryPage = () => {
  const [categories, setCategories] = useState([
    { id: 1, name: "Website", status: true },
    { id: 2, name: "Mobile App", status: true },
    { id: 3, name: "Branding", status: false },
  ]);
    ...
    },
    {
      ...
      render: (_, row) => (
        <div className="flex gap-2 items-center">
          <Link href={`/portfolio/category/edit/${row.id}`}>
            <button
      ...
      <Layout>
        ...
        <div className="bg-white rounded-2xl mt-6 p-4">
          <div className="flex items-center justify-between mb-6">
            <h3 className="text-[#181818] font-semibold text-xl">Category</h3>
            <Link href={"/portfolio/category/add-category"}>
