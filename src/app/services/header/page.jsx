...
const ServicesHeader = () => {
  ...
  const headerId = 1; // Mock ID - replace with actual data ID
      ...
      <Layout>
        <div className="flex items-center justify-between">
          ...
          <select
            id="service"
            name="service"
            class="rounded-xl border border-gray-300 bg-white px-4 py-3 text-gray-700 shadow-sm outline-none transition-all duration-200 focus:border-[#0E4F53] focus:ring-2 focus:ring-[#0E4F53]"
          >
        ...
        <div className="bg-white rounded-2xl mt-6 p-4">
          <div className="flex items-center justify-between mb-6">
            <h3 className="text-[#181818] font-semibold text-xl">Header</h3>
            ...
            <table className="min-w-full text-left text-sm text-gray-700">
              ...
              <tbody>
                <tr className="border-b border-[#DCDCDC] align-top">
                  ...
                  <td className="px-4 py-3">Utilizing Leading Tech</td>
                  ...
                  <td className="px-4 py-3 flex gap-2 items-center">
                    {/* Edit Icon */}
                    <Link
                      href={`/services/header/edit-services-header/${
                        headerId || 1
                      }`}
                    >
